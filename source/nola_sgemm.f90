 ...
 !  ===========
 !
 !       SUBROUTINE NOLA_SGEMM(TRANSA,TRANSB,M,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
 !
 !       .. Scalar Arguments ..
 !       REAL ALPHA,BETA
 ...
 !> \verbatim
 !>
 !> NOLA_SGEMM  performs one of the matrix-matrix operations
 !>
 ...
 !
       ...
       END IF
       IF (info.NE.0) THEN
           CALL nola_xerbla('NOLA_SGEMM ',info)
           RETURN
       END IF
 !
