...
template <class Real>
inline Real
arithmetic_mean_parallel_impl(std::int32_t n, const Real x[ ])
{
...
template <class Real>
inline Real
variance_parallel_impl(std::int32_t n, const Real x[ ])
{
...
template <class Real>
inline Real
standard_deviation_parallel_impl(std::int32_t n, const Real x[ ])
{
  // Compute the mean of the sequence
  Real sum{0.0};
...
template <class Real>
inline Real
covariance_parallel_impl(std::int32_t n, const Real x[ ], const Real y[ ])
{
...
template <class Real>
inline Real
correlation_parallel_impl(std::int32_t n, const Real x[ ], const Real y[ ])
{
  // Compute the mean of the two sequences
  Real sum1{0.0};
  Real sum2{0.0};
