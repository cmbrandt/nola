...
bisection_impl(UnaryFunction&& f, Real a, Real b, Real tol, std::int32_t iter)
{
...
template <class UnaryFunction, class Real>
inline std::tuple<Real, std::int32_t>
brent_impl(UnaryFunction&& f, Real x0, Real x1, Real tol, std::int32_t iter)
{
  Real fx0 = f(x0);
  Real fx1 = f(x1);
...
template <class UnaryFunction, class Real>
inline std::tuple<Real, std::int32_t>
fixed_point_impl(UnaryFunction&& g, Real x0, Real tol, std::int32_t iter)
{
  Real eps = std::numeric_limits<Real>::epsilon();
...
inline std::tuple<Real, std::int32_t>
newton_impl(UnaryFunction1&& f, UnaryFunction2&& fp, Real x0, Real tol, std::int32_t iter)
{
  Real eps = std::numeric_limits<Real>::epsilon();
...
template <class UnaryFunction, class Real>
inline std::tuple<Real, std::int32_t>
secant_impl(UnaryFunction&& f, Real x0, Real x1, Real tol, std::int32_t iter)
{
  Real eps = std::numeric_limits<Real>::epsilon();
