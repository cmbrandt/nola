...
#include <nola/detail/stat_parallel_impl.hxx>
#include <nola/detail/stat_parallel_simd_impl.hxx>
#include <nola/detail/stat_simd_impl.hxx>
...
inline Real
arithmetic_mean(ExecutionPolicy&& exec, std::int32_t n, Real const x[ ]);
...
template <class ExecutionPolicy, class Real>
inline Real
variance(ExecutionPolicy&& exec, std::int32_t n, Real const x[ ]);
...
template <class ExecutionPolicy, class Real>
inline Real
standard_deviation(ExecutionPolicy&& exec, std::int32_t n, Real const x[ ]);
...
template <class ExecutionPolicy, class Real>
inline Real
covariance(ExecutionPolicy&& exec, std::int32_t n, Real const x[ ], Real const y[ ]);
...
template <class ExecutionPolicy, class Real>
inline Real
correlation(ExecutionPolicy&& exec, std::int32_t n, Real const x[ ], Real const y[ ]);
